...
public class javamail {
	...
	public String envoiMessage() throws InterruptedException {
	    ...
	    try {
	        ...
	        message.setRecipients(Message.RecipientType.TO,
	                InternetAddress.parse(NOAA));
	        message.setSubject("Teste");
	        message.setText("Send grib:"+getlattitudepg()+"S,"+getlattitudepd()+"S,"+getlongitudepg()+"W,"+getlongitudepd()+"W|1,1|00,12,24|WIND");
	...
	public String receiveMessage() {
		...
		try {
			   ...
			   titregrib=recuperationfichiergrib(messages[messages.length-1]);
	...
	private String recuperationfichiergrib(Message message) throws FileNotFoundException, MessagingException, IOException {
	...
	public static void main(String[] args) throws InterruptedException {
	    ...
	    javamail monmail = new javamail();
	    monmail.setdonneeenvoyee(12, 24, 18, 30);
	    System.out.println(monmail.envoiMessage());
